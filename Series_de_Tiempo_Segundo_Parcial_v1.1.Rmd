...
# Fit the SARIMA model
SARIMA_PDQS_Demanda_electrico_V2_model <- Arima(Demanda_electrico_train_V2, order = c(1, 1, 1), seasonal = list(order = c(0, 1, 1), period = 12))
...
## Aplicando el auto.arima a la serie 3 (Demanda_electrico)



### Transformando la variable dependiente (LOG(Y)) a la serie 3 (Demanda_electrico)
