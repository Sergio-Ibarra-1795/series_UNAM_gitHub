---
title: "Series_Class_23_Mayo_Aplicacion_Modelos_ARIMA_y_Lineales_a_mis_datos_demanda_electrico_V2"
author: "Sergi"
date: "2023-02-27"
...
# Fit the SARIMA model with seasonal component
SARIMA_1_1_1_Demanda_electrico_VST_seasonal_V2 <- astsa::sarima(Demanda_electrico_sin_differencia_train_VST, 
                                                             p = 1, d = 1, q = 0,
                                                             P = 0, D = 1, Q = 1,
                                                             S = 12)

# Print the model summary
summary(SARIMA_1_1_1_Demanda_electrico_VST_seasonal_V2)

SARIMA_1_1_1_Demanda_electrico_VST_seasonal_V2$fit

SARIMA_1_1_1_Demanda_electrico_VST_seasonal_V2$ttable
...
ts_data <- ts(Demanda_electrico_sin_differencia_train_VST)

# Fit the SARIMA model
model <- Arima(ts_data, order = c(1, 1, 1), seasonal = list(order = c(0, 1, 1), period = 12))
...
```{r}
AUTO_ARIMA_Demanda_electrico_VST_seasonal$arma
```


```{r}
forecast_Auto_ARIMA <- forecast(AUTO_ARIMA_Demanda_electrico_VST_seasonal, h=12)
# Print the forecasted values
