...
##Expandimos nuestra 'Serie original de nacimientos' a los sisuigentes 5 datos a pronosticar para poder tener un onjeto del mismo tamaño de nuestro pronóstico [27 +5]
nacimientos_mex_A<-c(nacimientos_mex$Births, rep(NA, times=5))
plot(nacimientos_mex_A, type="l")
```
...
lines(new_dates, Est_punt_nacimientos, col="blue")
