...
plot(Demanda_electrico_completa$Date,Demanda_electrico_pronostico, type="l", main = "Estimación puntual de demanda de gas natrual para los siguientes 12 meses (sin componentes de estacionalidad ni tendencia) con el método de 'suavizamiento estático' ", cex.main=0.5)
...
## Conclusiones generales sobre las técnicas de suavizamiento estáticas y dinámicas (HoltWinters)
