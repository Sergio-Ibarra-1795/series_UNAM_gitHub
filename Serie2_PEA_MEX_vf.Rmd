...
plot(PEA_mex$Date, PEA_Sin_Tendencia, type="l", main=" Data sin tendencia de PAE_MX ")
```
...
Una vez teniendo la serie sin tendencia  podemos determinar el componente de "ruido blanco" de la serie 
```{r}
