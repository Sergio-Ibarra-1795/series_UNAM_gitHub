...
# plot the original data and the predicted values together
plot(extended_dates, nacimientos_original_para_pron,main="Estimación de 6 valores de la Población eocnomicamente activa con intervalos de confianza al 95%", type="l", xlab="Year", ylab="Births")
lines(extended_dates, Est_punt_PEA, col="blue")
