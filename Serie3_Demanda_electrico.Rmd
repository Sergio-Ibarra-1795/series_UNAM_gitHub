...
## Serie de tiempo CON tendencia y CON estacionalidad (Historico de Demanda de Gas Natural para el sector eléctrico en México)
...
### En este caso se asumirá un "fecto multiplicativo" y por lo tanto se removerá dividiendo cada elemento de la serie original / valor de la linea de tendnecia en ese valor de x
...
Posteriormente calculamos los valores historicos + 12 meses pronosticados pero a partir de la linea de tendencia que previamente se habia calculado de nombre Electrico_Demanded_gas_line
...
Entonces para finalmente "devolver el efecto de la tendnecia a los datos de LS_demanda_electrico_cest" se multiplica cada valor de la serie por el valor calculado a partir de la linea de tencia que se llamaElectrico_Demanded_gas_line_aplicada2
```{r}
